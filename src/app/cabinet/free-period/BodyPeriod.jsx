  ...
  return (
    <div className="md:p-[50px] p-[15px] py-[30px] w-full">
      ...
      <div className="grid rounded-[10px] md:p-[40px] p-[20px] bg-white border-solid border border-black">
        ...
        <div className="flex md:gap-10 gap-6  mt-[50px] flex-wrap ">
          <select
            name=""
            id=""
            className="border border-black rounded min-w-[200px] outline-none pl-3 p-[10px] font-semibold"
          >
            {[1, 2, 3, 4, 5, 6, 7].map((item, i) => (
              <option value={item} key={i}>{item} day</option>
            ))}
          </select>
          <select
            name=""
          ...
          >
            {[
              ...
              <option value={item} key={i}>{item} GB</option>
            ))}
          </select>
          <div className="flex relative md:left-0 -left-[15px]">
          ...
          <div className="flex relative md:left-0 -left-[10px]">
